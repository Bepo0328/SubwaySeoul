...
import kr.co.bepo.subway_seoul.databinding.FragmentStationArrivalsBinding
...
class StationArrivalsFragment : ScopeFragment(), StationArrivalsContract.View {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        menu.findItem(R.id.favoriteAction).apply {
            setIcon(
                if (arguments.station.isFavorited) R.drawable.ic_star
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean =
        when (item.itemId) {
            ...
            R.id.favoriteAction -> {
                ...
                item.setIcon(
                    if (item.isChecked) R.drawable.ic_star
                    else R.drawable.ic_star_empty
                )
